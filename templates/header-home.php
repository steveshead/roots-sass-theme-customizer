...
<?php $frontpage_theme_header_bg = get_theme_mod('frontpage_theme_header_bg'); ?>
 
 <?php
     $frontpage_header_background_repeat = get_theme_mod( 'frontpage_header_background_repeat' );
     if( $frontpage_header_background_repeat != '' ) {
         switch ( $frontpage_header_background_repeat ) {
             case 'no-repeat':
	             echo '<style type="text/css">';
	             echo '.custom-header { background-repeat:no-repeat;background-size:cover; }';
	             echo '</style>';
                 break;
             case 'repeat':
                 echo '<style type="text/css">';
                 echo '.custom-header { background-repeat:repeat; }';
                 echo '</style>';
                 break;
             case 'repeat-x':
                 echo '<style type="text/css">';
                 echo '.custom-header { background-repeat:repeat-x; }';
                 echo '.custom-header { float: none; margin-left: auto; margin-right: auto; }';
                 echo '</style>';
                 break;
             case 'repeat-y':
                 echo '<style type="text/css">';
                 echo '.custom-header { background-repeat:repeat-y; }';
                 echo '.custom-header { float: none; margin-left: auto; margin-right: auto; }';
                 echo '</style>';
                 break;
         }
...
<?php
     $frontpage_header_background_attachment = get_theme_mod( 'frontpage_header_background_attachment' );
     if( $frontpage_header_background_attachment != '' ) {
         switch ( $frontpage_header_background_attachment ) {
             case 'fixed':
	             echo '<style type="text/css">';
	             echo '.custom-header { background-attachment:fixed; }';
	             echo '</style>';
                 break;
             case 'repeat':
                 echo '<style type="text/css">';
                 echo '.custom-header { background-attachment:scroll; }';
                 echo '</style>';
                 break;
         }
     }
...
<div class="custom-header" style="background-image:url('<?php echo $frontpage_theme_header_bg ?>');">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
